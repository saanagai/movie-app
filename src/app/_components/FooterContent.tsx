...
export function FooterContent() {
  return (
    <div className="bg-[#4338CA] w-[100%] h-[280px] ">
      <div className="max-w-[1280px] m-auto text-white flex justify-between gap-10 py-[40px]">
        ...
        <div>
          ...
          <svg
            ...
            fill="none"
          >
            <g clipPath="url(#clip0_3055_4551)">
              <path
        ...
        <div className="font-medium text-sm">
          <p>Follow us</p>
          <p>Facebook Instaghram Twiter Youtube</p>
        </div>
      </div>
    </div>
  );
